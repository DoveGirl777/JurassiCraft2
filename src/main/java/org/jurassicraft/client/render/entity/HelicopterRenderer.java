...
public abstract class HelicopterRenderer<E extends CarEntity> extends Render<E> {
    ...
    protected HelicopterRenderer(RenderManager renderManager, String carName) {
        ...
        this.animator = createHeliAnimator();
    ...
    protected abstract HelicopterAnimator createHeliAnimator();
    @Nullable
    @Override
